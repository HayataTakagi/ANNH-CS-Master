...
def main():
    ...
    q_ne_sum_data = np.loadtxt('../data/Q-UN-SUM.csv', skiprows=2, delimiter=',')
    ...
    q_ne_max_data = np.loadtxt('../data/Q-UN-MAX.csv', skiprows=2, delimiter=',')
    ...
    fig.savefig('export/querysize-UN.pdf', facecolor=fig.get_facecolor(), edgecolor=fig.get_edgecolor())
