...
def main():
    ...
    ds_cas_sum_data_ = ds_cas_sum_data / 1000  # μsからmsへの変換
    ...
    ds_cas_max_data_ = ds_cas_max_data / 1000  # μsからmsへの変換
    ...
    ds_un_sum_data_ = ds_un_sum_data / 1000  # μsからmsへの変換
    ...
    ds_un_max_data_ = ds_un_max_data / 1000  # μsからmsへの変換
