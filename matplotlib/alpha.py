...
def main():
    ...
    ax.plot(ne_sum_data[:, 0], ne_sum_data_[:, 1], marker='x', label='Point')
    ax.plot(ne_sum_data[:, 0], ne_sum_data_[:, 2], marker='s', label='MBR')
    ...
    ax2.plot(ne_max_data[:, 0], ne_max_data_[:, 1], marker='x')
    ax2.plot(ne_max_data[:, 0], ne_max_data_[:, 2], marker='s')
    ...
    ax3.plot(cas_sum_data[:, 0], cas_sum_data_[:, 1], marker='x')
    ax3.plot(cas_sum_data[:, 0], cas_sum_data_[:, 2], marker='s')
    ...
    ax4.plot(cas_max_data[:, 0], cas_max_data_[:, 1], marker='x')
    ax4.plot(cas_max_data[:, 0], cas_max_data_[:, 2], marker='s')
    ax4.plot(cas_max_data[:, 0], cas_max_data_[:, 3], marker='o')
    ...
    ax5.plot(un_sum_data[:, 0], un_sum_data_[:, 1], marker='x')
    ax5.plot(un_sum_data[:, 0], un_sum_data_[:, 2], marker='s')
    ...
    ax6.plot(un_max_data[:, 0], un_max_data_[:, 1], marker='x')
    ax6.plot(un_max_data[:, 0], un_max_data_[:, 2], marker='s')
    ...
    fig.savefig('export/alpha2.pdf', facecolor=fig.get_facecolor(), edgecolor=fig.get_edgecolor())
