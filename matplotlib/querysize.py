...
def main():
    ...
    q_cas_sum_data_ = q_cas_sum_data / (1000 * test_size)  # μsからmsへの変換
    ...
    q_cas_max_data_ = q_cas_max_data / (1000 * test_size)  # μsからmsへの変換
    ...
    q_un_sum_data_ = q_un_sum_data / (1000 * test_size)  # μsからmsへの変換
    ...
    q_un_max_data_ = q_un_max_data / (1000 * test_size)  # μsからmsへの変換
    ...
    fig.savefig('export/querysize2.pdf', facecolor=fig.get_facecolor(), edgecolor=fig.get_edgecolor())
