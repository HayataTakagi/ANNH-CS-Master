...
def main():
    ...
    gs_cas_sum_data_ = gs_cas_sum_data / 10  # μsからmsへの変換
    ...
    gs_cas_max_data_ = gs_cas_max_data / 10  # μsからmsへの変換
    ...
    gs_un_sum_data_ = gs_un_sum_data / 10  # μsからmsへの変換
    ...
    gs_un_max_data_ = gs_un_max_data / 10  # μsからmsへの変換
