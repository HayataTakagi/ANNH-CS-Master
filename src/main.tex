...
\begin{figure}
    ...
    \end{center}
    \caption{$f=sum$, CAS, $\alpha$ = 0.5 , $\beta$ = 0.5 ,k = 50, $\mid$Q$\mid$ = 5, n = $128^2$}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.8\textwidth]{src/images/CAS-SUM-GridSize.pdf}
    \end{center}
    \caption{$f=max$, CAS, $\alpha$ = 0.5 , $\beta$ = 0.5 ,k = 50, $\mid$Q$\mid$ = 5, n = $128^2$}
