...
\STATE $pNext \xleftarrow[]{}$ retrieve nearest point to $Q$ from $nexCells$
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.8\textwidth]{src/images/NE-SUM-Q.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.8\textwidth]{src/images/NE-MAX-Q.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.8\textwidth]{src/images/CAS-SUM-Q.png}
    \end{center}
    \caption{$f=sum$, CAS, $\alpha$ = 0.5 , $\beta$ = 0.5 , $\mid$P$\mid$ = 196,902, k = 50, n = $128^2$}
    \label{fig:sum-querySize-CAS}
\end{figure}

\begin{figure}
    \begin{center}
        \includegraphics[width=0.8\textwidth]{src/images/CAS-MAX-Q.png}
    \end{center}
    \caption{$f=max$, CAS, $\alpha$ = 0.5 , $\beta$ = 0.5 , $\mid$P$\mid$ = 196,902, k = 50, n = $128^2$}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.8\textwidth]{src/images/NE-SUM-K.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.8\textwidth]{src/images/NE-MAX-K.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.8\textwidth]{src/images/CAS-SUM-K.png}
    \end{center}
    \caption{$f=sum$, CAS, $\alpha$ = 0.5 , $\beta$ = 0.5 , $\mid$P$\mid$ = 196,902, $\mid$Q$\mid$ = 5, n = $128^2$}
    \label{fig:sum-clusterSize-CAS}
\end{figure}

\begin{figure}
    \begin{center}
        \includegraphics[width=0.8\textwidth]{src/images/CAS-MAX-K.png}
    \end{center}
    \caption{$f=max$, CAS, $\alpha$ = 0.5 , $\beta$ = 0.5 , $\mid$P$\mid$ = 196,902, $\mid$Q$\mid$ = 5, n = $128^2$}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.8\textwidth]{src/images/UN-SUM.png}
    \end{center}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.8\textwidth]{src/images/UN-MAX.png}
    \end{center}
