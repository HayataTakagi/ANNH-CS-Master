...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.8\textwidth]{matplotlib/export/querysize.eps}
    \end{center}
    \caption{Running time versus query size.}
    \label{fig:sum-querySize2}
\end{figure}
